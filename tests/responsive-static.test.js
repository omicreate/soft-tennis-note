...
assert.match(html, /class="analysis-section analysis-overall-section"[\s\S]*class="opponent-view"[\s\S]*class="action-plan"[\s\S]*得点しやすい場面[\s\S]*失点しやすい場面[\s\S]*ラリーの長さ[\s\S]*class="analysis-section analysis-player-section"[\s\S]*選手別 成長メモ[\s\S]*選手別 サーブ\/レシーブ/, "分析画面は全体分析と個人別分析に項目を分ける");

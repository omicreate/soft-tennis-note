...
assert.equal(shareLayout.pageCount, 3, "fixtureでも共有用サマリーは3ページ相当で生成する");
assert.equal(detailLayout.pageCount, 5, "fixtureでも詳細サマリーは5ページ相当で生成する");
assert.ok(detailLayout.contentBottom < detailLayout.footerTop, "fixtureの詳細サマリー本文がフッターに重ならない");
